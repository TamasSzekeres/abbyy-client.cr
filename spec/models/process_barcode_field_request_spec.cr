...
describe ProcessBarcodeFieldRequest do
  request = ProcessBarcodeFieldRequest.new file_path: TEST_VALID_FILE_PATH

  it "raises ArgumentError because of invalid filepath" do
    expect_raises(ArgumentError) do
      ProcessBarcodeFieldRequest.new file_path: TEST_INVALID_FILE_PATH
    end
