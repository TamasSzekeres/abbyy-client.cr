...
describe ProcessCheckmarkFieldRequest do
  request = ProcessCheckmarkFieldRequest.new file_path: TEST_VALID_FILE_PATH

  it "raises ArgumentError because of invalid filepath" do
    expect_raises(ArgumentError) do
      ProcessCheckmarkFieldRequest.new file_path: TEST_INVALID_FILE_PATH
    end
